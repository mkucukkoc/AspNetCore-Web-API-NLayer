...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20220925123245_initial2")]
            ...
            modelBuilder.Entity("NLayer.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 25, 15, 32, 44, 185, DateTimeKind.Local).AddTicks(8404),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 25, 15, 32, 44, 185, DateTimeKind.Local).AddTicks(8418),
                            Name = "Kalem 2",
                            Price = 200m,
                            Stock = 10
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 25, 15, 32, 44, 185, DateTimeKind.Local).AddTicks(8422),
                            Name = "Kalem 3",
                            Price = 50m,
                            Stock = 20
                        });
